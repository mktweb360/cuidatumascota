...
export const posts: Post[] = [
  ...
  },
  {
    ...
    date: "2025-04-01",
    readTime: 7,
    relatedProducts: ["trixie-cama-ortopedica-vital-bendson"],
  ...
  },
  {
    ...
    date: "2025-04-15",
    readTime: 10,
    relatedProducts: ["orijen-original-dog-11kg", "applaws-taquitos-pollo-perro-natural-90g"],
  ...
  {
    slug: "adiestramiento-clicker-perros-guia-inicio",
    image: "/images/blog/adiestramiento-clicker-perros-guia-inicio.jpg",
    title: "Adiestramiento con clicker para perros: guía para empezar 2026",
    excerpt: "Qué es el clicker training, por qué marca mejor la conducta que la voz, cómo \"cargar\" el clicker en 3 sesiones y los errores más comunes al empezar con tu perro.",
    category: "Adiestramiento",
    date: "2026-09-06",
    readTime: 9,
    relatedProducts: ["petsafe-clikr-clicker-adiestramiento-perro", "correa-larga-adiestramiento-10m-perro", "rinonera-porta-premios-adiestramiento-perro"],
    relatedPosts: ["ordenes-basicas-perro-guia", "ansiedad-separacion-perros", "cuidados-cachorro-primer-mes", "pasear-perro-correctamente-guia"],
    categoryCta: { href: "/tienda/accesorios-perros", text: "Ver clickers y accesorios de adiestramiento →" },
  },
  {
    slug: "royal-canin-kitten-analisis",
    image: "/images/blog/royal-canin-kitten-analisis.jpg",
    title: "Royal Canin Kitten: análisis completo y cuándo empezar a darlo 2026",
    excerpt: "Análisis del pienso Royal Canin Kitten: composición, a qué edad exacta empezar, cuándo hacer la transición a adulto y si compensa frente a alternativas.",
    category: "Alimentación",
    date: "2026-09-07",
    readTime: 8,
    relatedProducts: ["royal-canin-kitten-4kg", "purina-one-bifensis-sterilcat-hairball-8x800g"],
    relatedPosts: ["pienso-gato-adulto-comparativa", "gato-primer-dia-casa-guia", "alimentacion-gatos-guia-propietarios"],
    isHealth: true,
    categoryCta: { href: "/tienda/alimentacion-gatos", text: "Ver piensos para gatos →" },
  },
  {
    slug: "purina-pro-plan-puppy-start-analisis",
    image: "/images/blog/purina-pro-plan-puppy-start-analisis.jpg",
    title: "Purina Pro Plan Puppy Start: análisis completo para cachorros 2026",
    excerpt: "Análisis del pienso Purina Pro Plan Medium Puppy Start: composición, para qué cachorros es adecuado, calendario de tomas y cuándo pasar a la fórmula adulta.",
    category: "Alimentación",
    date: "2026-09-07",
    readTime: 8,
    relatedProducts: ["purina-pro-plan-puppy-start-cachorro-3kg", "kong-puppy-goodie-bone"],
    relatedPosts: ["mejor-pienso-perro-2025", "cuidados-cachorro-primer-mes", "adiestramiento-clicker-perros-guia-inicio"],
    isHealth: true,
    categoryCta: { href: "/tienda/alimentacion-perros", text: "Ver piensos para cachorros →" },
  },
  {
    slug: "savic-nestor-arenero-analisis",
    image: "/images/blog/savic-nestor-arenero-analisis.jpg",
    title: "Savic Nestor: análisis del arenero cerrado y cómo elegir el tuyo 2026",
    excerpt: "Análisis del arenero cerrado Savic Nestor: ventajas y desventajas frente a un arenero abierto, mantenimiento, filtro de carbón y cómo elegir tamaño y ubicación.",
    category: "Cuidados",
    date: "2026-09-07",
    readTime: 8,
    relatedProducts: ["savic-nestor-arenero-cerrado-gatos", "amazon-basics-alfombra-arenero-gatos"],
    relatedPosts: ["gato-interior-bienestar-enriquecimiento", "gato-primer-dia-casa-guia", "alimentacion-gatos-guia-propietarios"],
    categoryCta: { href: "/tienda/accesorios-gatos", text: "Ver areneros y accesorios de higiene felina →" },
  },
  {
    slug: "baskerville-bozal-cesta-analisis",
    image: "/images/blog/baskerville-bozal-cesta-analisis.jpg",
    title: "Bozal de cesta Baskerville: cuándo usarlo y cómo acostumbrar a tu perro 2026",
    excerpt: "Análisis del bozal de cesta Baskerville Classic: en qué situaciones es recomendable, diferencias con el bozal de tela y cómo habituar a tu perro sin estrés.",
    category: "Adiestramiento",
    date: "2026-09-07",
    readTime: 7,
    relatedProducts: ["baskerville-classic-bozal-cesta", "ezydog-cinturon-seguridad-coche-perro"],
    relatedPosts: ["adiestramiento-clicker-perros-guia-inicio", "ordenes-basicas-perro-guia", "pasear-perro-correctamente-guia"],
    categoryCta: { href: "/tienda/accesorios-perros", text: "Ver accesorios de adiestramiento →" },
  },
  {
    slug: "eliminar-pulgas-casa-guia-completa",
    image: "/images/blog/eliminar-pulgas-casa-guia-completa.jpg",
    title: "Cómo eliminar las pulgas de casa (no solo del perro o del gato): guía completa 2026",
    excerpt: "Tratar solo al perro o al gato no basta: la mayor parte del ciclo de vida de la pulga transcurre en el hogar. Guía paso a paso para desinfestar la casa, el coche y las zonas exteriores, y evitar que la infestación vuelva.",
    category: "Salud",
    date: "2026-09-09",
    readTime: 10,
    relatedProducts: ["frontline-plus-perros-grandes-6-pipetas", "frontline-combo-gato", "frontline-homeguard-spray-antipulgas-hogar-500ml", "trixie-peine-antipulgas-polvo"],
    relatedPosts: ["antiparasitarios-perros-guia", "desparasitacion-gatos-guia", "cuidado-preventivo-mascotas-guia"],
    isHealth: true,
    categoryCta: { href: "/tienda/salud-higiene", text: "Ver antiparasitarios y productos de salud →" },
  },
];
